...
import type { BaseResponseListPersonalQuestionVO } from "../models/BaseResponseListPersonalQuestionVO";
...
export class UserControllerService {
  ...
  /**
   * @param userId
   * @returns BaseResponseListPersonalQuestionVO OK
   * @throws ApiError
   */
  public static getPersonalQuestionVo(
    userId: number
  ): CancelablePromise<BaseResponseListPersonalQuestionVO> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/user/personalQuestion",
      query: {
        userId: userId,
      },
    });
